...
```diff
-    "capacitor-notificare": "^4.0.0",
-    "capacitor-notificare-assets": "^4.0.0",
-    "capacitor-notificare-geo": "^4.0.0",
-    "capacitor-notificare-in-app-messaging": "^4.0.0",
-    "capacitor-notificare-inbox": "^4.0.0",
-    "capacitor-notificare-loyalty": "^4.0.0",
-    "capacitor-notificare-push": "^4.0.0",
-    "capacitor-notificare-push-ui": "^4.0.0",
-    "capacitor-notificare-user-inbox": "^4.0.0",

+    "capacitor-actito": "^5.0.0",
+    "capacitor-actito-assets": "^5.0.0",
+    "capacitor-actito-geo": "^5.0.0",
+    "capacitor-actito-in-app-messaging": "^5.0.0",
+    "capacitor-actito-inbox": "^5.0.0",
+    "capacitor-actito-loyalty": "^5.0.0",
+    "capacitor-actito-push": "^5.0.0",
+    "capacitor-actito-push-ui": "^5.0.0",
+    "capacitor-actito-user-inbox": "^5.0.0",
```
...
Similarly, update all imports from the `import { Notificare* } from 'capacitor-notificare*'` to `import { Actito* } from 'capacitor-actito*'`.

Here is an example from the inbox implementation:

```diff
- import { NotificareInbox, NotificareInboxItem } from 'capacitor-notificare-inbox';
- import { NotificarePushUI } from 'capacitor-notificare-push-ui';

+ import { ActitoInbox, ActitoInboxItem } from 'capacitor-actito-inbox';
