...
public class ActitoPushPlugin : Plugin() {
    ...
    public fun hasRemoteNotificationsEnabled(call: PluginCall) {
        call.resolve(
            JSObject().apply {
                put("result", Actito.push().hasRemoteNotificationsEnabled)
            }
        )
    }
    ...
    public fun getTransport(call: PluginCall) {
        call.resolve(
            JSObject().apply {
                put("result", Actito.push().transport?.rawValue)
            }
        )
    }
    ...
    public fun getSubscription(call: PluginCall) {
        try {
            call.resolve(
                JSObject().apply {
                    put("result", Actito.push().subscription?.toJson())
                }
            )
        } catch (e: Exception) {
    ...
    public fun allowedUI(call: PluginCall) {
        call.resolve(
            JSObject().apply {
                put("result", Actito.push().allowedUI)
            }
        )
    }
