...
public class ActitoGeoPlugin: CAPPlugin, CAPBridgedPlugin {
    ...
    public let pluginMethods: [CAPPluginMethod] = [
        ...
        CAPPluginMethod(name: "getEnteredRegions", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "enableLocationUpdates", returnType: CAPPluginReturnPromise),
        CAPPluginMethod(name: "disableLocationUpdates", returnType: CAPPluginReturnPromise),
