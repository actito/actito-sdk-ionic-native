...
export class ActitoGeo {
   ...
   */
  public static async onLocationUpdated(callback: (location: ActitoLocation) => void): Promise<PluginListenerHandle> {
   ...
   */
  public static async onRegionEntered(callback: (region: ActitoRegion) => void): Promise<PluginListenerHandle> {
   ...
   */
  public static async onRegionExited(callback: (region: ActitoRegion) => void): Promise<PluginListenerHandle> {
   ...
   */
  public static async onBeaconEntered(callback: (beacon: ActitoBeacon) => void): Promise<PluginListenerHandle> {
   ...
   */
  public static async onBeaconExited(callback: (beacon: ActitoBeacon) => void): Promise<PluginListenerHandle> {
   ...
   */
  public static async onVisit(callback: (visit: ActitoVisit) => void): Promise<PluginListenerHandle> {
   ...
   */
  public static async onHeadingUpdated(callback: (heading: ActitoHeading) => void): Promise<PluginListenerHandle> {
