...
//   IonToolbar,
// } from '@ionic/react';
// import type { ActitoBeacon, ActitoRegion } from 'capacitor-actito-geo';
...
//   const [data, setData] = useState<{ region: ActitoRegion; beacons: ActitoBeacon[] }>();
//
//   useEffect(function setupListeners() {
//     const listeners = [ActitoGeo.onBeaconsRanged(setData)];
//
//     return () => {
