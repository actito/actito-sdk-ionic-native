...
export const InboxView: FC = () => {
  ...
  const [selectedItem, setSelectedItem] = useState<ActitoInboxItem | null>(null);
  ...
  useEffect(function setupListeners() {
    const listeners = [ActitoInbox.onInboxUpdated(setItems)];
  ...
  function onTouchStart(item: ActitoInboxItem) {
  ...
  async function onTouchEnd(item: ActitoInboxItem) {
    clearTimeout(pressTimer);
