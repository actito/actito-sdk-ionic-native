...
// import { ActitoGeo, PermissionGroup, PermissionStatus } from 'capacitor-actito-geo';
...
//       (async () => {
//         try {
//           const status = await ActitoGeo.checkPermissionStatus(PermissionGroup.LOCATION_WHEN_IN_USE);
//
//           const enabled = (await ActitoGeo.hasLocationServicesEnabled()) && status === PermissionStatus.GRANTED;
//
...
//     let status = await ActitoGeo.checkPermissionStatus(PermissionGroup.LOCATION_WHEN_IN_USE);
//     if (status == PermissionStatus.GRANTED) return true;
//
//     if (await ActitoGeo.shouldShowPermissionRationale(PermissionGroup.LOCATION_WHEN_IN_USE)) {
//       await ActitoGeo.presentPermissionRationale(PermissionGroup.LOCATION_WHEN_IN_USE, {
//         title: 'Sample',
//         message: 'We need access to foreground location in order to show relevant content.',
//       });
//     }
//
//     status = await ActitoGeo.requestPermission(PermissionGroup.LOCATION_WHEN_IN_USE);
//
...
//       await ActitoGeo.openAppSettings();
//       return false;
//     }
//
...
//     let status = await ActitoGeo.checkPermissionStatus(PermissionGroup.LOCATION_ALWAYS);
//     if (status == PermissionStatus.GRANTED) return true;
//
//     if (await ActitoGeo.shouldShowPermissionRationale(PermissionGroup.LOCATION_ALWAYS)) {
//       await ActitoGeo.presentPermissionRationale(PermissionGroup.LOCATION_ALWAYS, {
//         title: 'Sample',
//         message: 'We need access to background location in order to show relevant content.',
//       });
//     }
//
//     status = await ActitoGeo.requestPermission(PermissionGroup.LOCATION_ALWAYS);
//
//     if (status == PermissionStatus.PERMANENTLY_DENIED) {
//       addToastInfoMessage({
...
//     let status = await ActitoGeo.checkPermissionStatus(PermissionGroup.BLUETOOTH_SCAN);
//     if (status == PermissionStatus.GRANTED) return true;
//
//     if (await ActitoGeo.shouldShowPermissionRationale(PermissionGroup.BLUETOOTH_SCAN)) {
//       await ActitoGeo.presentPermissionRationale(PermissionGroup.BLUETOOTH_SCAN, {
//         title: 'Sample',
//         message: 'We need access to bluetooth scan in order to show relevant content.',
//       });
//     }
//
//     status = await ActitoGeo.requestPermission(PermissionGroup.BLUETOOTH_SCAN);
//
//     if (status == PermissionStatus.PERMANENTLY_DENIED) {
//       addToastInfoMessage({
