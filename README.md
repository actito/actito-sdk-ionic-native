...
# Actito Ionic Native SDK

[![GitHub release](https://img.shields.io/github/v/release/actito/actito-sdk-ionic-native)](https://github.com/actito/actito-sdk-ionic-native/releases)
[![License](https://img.shields.io/github/license/actito/actito-sdk-ionic-native)](https://github.com/actito/actito-sdk-ionic-native/blob/main/LICENSE)

The Actito Ionic Native SDK makes it quick and easy to communicate efficiently with many of the Actito API services and enables you to seamlessly integrate our various features, from Push Notifications to Contextualised Storage.
...
To integrate the Actito Ionic Native SDK into your application, follow the full setup and implementation guides available in our [official documentation](https://developers.actito.com/docs/push-implementation/ionic-native/implementation/)
...
The [example project](https://github.com/Actito/actito-sdk-ionic-native/tree/main/packages/sample) demonstrates other integrations in a simplified fashion, to quickly understand how a given feature should be implemented.
